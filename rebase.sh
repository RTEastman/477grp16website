...
do
	...
	# sed -i 's|base href="https://engineering.purdue.edu/ece477/StudentWebTemplate|base href="https://engineering.purdue.edu/477grp16|' ${f}
	sed -i 's|base href="https://engineering.purdue.edu/ece477grp16|' ${f}
done
